...
public class MilkywayStartSearch {

	private static int toGenerate = 2000;

	private static String workunit_xml_filename = "templates/milkyway_wu.xml";
	private static String result_xml_filename = "templates/a_result.xml";
